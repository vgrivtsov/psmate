...
urlpatterns = [
    ...
    path('login', auth_views.LoginView.as_view(template_name='layouts/layout.html', success_url = "/cabinet/"), name='login'),
    path('logout', auth_views.LogoutView.as_view(template_name='layouts/layout.html', success_url = "/"), name='logout'),     
